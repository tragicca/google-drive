...
pluralCaseList.push( {plural: "drives/fileInfos", pascal: "DriveFileInfo"} )

pluralCaseList.push( {plural: "indexers/indexedFiles", pascal: "IndexerIndexedFile"} )

pluralCaseList.push( {plural: "notifications/noficationInfos", pascal: "NotificationNoficationInfo"} )


pluralCaseList.push( {plural: "videoProcessings/videoFileInfos", pascal: "VideoProcessingVideoFileInfo"} )

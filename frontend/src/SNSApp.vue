            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="noficationInfos"
                        to="/notifications/noficationInfos"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="videoFileInfos"
                        to="/videoProcessings/videoFileInfos"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'indexedFiles', 
                route: '/indexers/indexedFiles',
                ImageUrl: '',
            },
            { 
                title: 'NoficationInfo', 
                description: '', 
                key: 'noficationInfos', 
                route: '/notifications/noficationInfos',
                ImageUrl: '',
            },
            { 
                title: 'VideoFileInfo', 
                description: '', 
                key: 'videoFileInfos', 
                route: '/videoProcessings/videoFileInfos',
                ImageUrl: '',
            },
